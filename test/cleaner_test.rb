...
class CleanerTest < MiniTest::Test
    ...
    def test_it_removes_initial_one_and_limits_to_ten_digits_when_number_is_too_long
      attendee = Attendee.new(:homephone => "1333444555566666")
      assert_equal "3334445555", attendee.phone_number
    end
